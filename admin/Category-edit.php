...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {    	
		...
		$statement = $pdo->prepare("UPDATE tbl_category SET category_name=?,ctype_id=? WHERE category_id=?");
		$statement->execute(array($_POST['category_name'],$_POST['ctype_id'],$_REQUEST['id']));
